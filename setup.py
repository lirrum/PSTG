...
Custom Markdown extensions for the *Lirrum‘s Storage Tech Guide* (LSTG) project.
...
setup(
    ...
    version="0.1.0",
    author="Lirrum",
    description="Custom Markdown extensions for LSTG, providing spoiler and inline style syntax.",
